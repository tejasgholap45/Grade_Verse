...
if(strlen($_SESSION['alogin'])=="")
    ...
    header("Location: index.php"); 
        ...
        {
        $id=$_GET['id'];
        $sql="delete from tblresults where id=:id";
...
<a href="manage-results.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to delete the result?');" class="btn btn-danger">
