...
.kklogo img {
    ...
    width: 800px; /* Set a specific width if needed */
}
        </style>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <!-- <div class="col-md-12">
                                    <h2 class="title" align="center">K. K. Wagh Arts, Commerce, Science and Computer Science College, Kakasaheb Nagar, Ranwad.</h2>
                                </div> -->
                            </div>
                            <!-- /.row -->
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <div class="kklogo">
                                                        <img src="assets/images/kklogo1.png" alt="" sty>
                                                    </div>
...
<tr>
    ...
    <td style="text-align: center">
        <b><?php echo htmlentities($totlcount); ?></b> out of <b><?php echo htmlentities($outof = ($cnt - 1) * 20); ?></b>
    </td>
</tr>
<tr>
    <th scope="row" colspan="2" style="text-align: center">Percentage</th>           
    <td style="text-align: center">
        <b><?php echo number_format(($totlcount * 100) / $outof, 2); ?> %</b>
    </td>
</tr>
